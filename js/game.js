...
class Game {
  constructor() {
    ...
    addEventListener("keydown", (e) => {
      ...
      /* N percorre as trilhas e termina em mudo. O toast existe porque a
         troca nao e instantanea (o arquivo novo carrega antes de entrar) e
         sem ele o jogador aperta a tecla e nao acontece nada por um segundo. */
      if (k === "n") {
