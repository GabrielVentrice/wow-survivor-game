...
Object.assign(CAPSTONES, {
  ...
  colheita: {
    id: "colheita", name: "Colheita", color: "#a8f05c",
  ...
  tirania: {
    id: "tirania", name: "Tirania", color: "#c07aff",
  ...
  nihilam: {
    id: "nihilam", name: "Nihilam", color: "#ffb54a",
  ...
  ceifador: {
    id: "ceifador", name: "Ceifador", color: "#7fdc4a",
  ...
  chamador: {
    id: "chamador", name: "Chamador", color: "#ff8a3c",
  ...
  diabolista: {
    id: "diabolista", name: "Diabolista", color: "#9a4cff",
  ...
  voraz: {
    id: "voraz", name: "Voraz", color: "#7fdc4a",
  ...
  enxame: {
    id: "enxame", name: "Enxame", color: "#9a4cff",
