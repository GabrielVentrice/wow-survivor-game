...
Object.assign(PASSIVES, {
  ...
  chamaVerde: {
    id: "chamaVerde", cls: "warlock", name: "Chama Verde", color: "#7fdc4a",
    desc: "Todo DoT tica 20% mais rápido — vale para qualquer peça que aplique DoT.",
    global: { dotHaste: 1.2 },
  },

  coroaDeOssos: {
    id: "coroaDeOssos", cls: "warlock", name: "Coroa de Ossos", color: "#e8e0c8",
  ...
  furiaContida: {
    id: "furiaContida", cls: "warlock", name: "Fúria Contida", color: "#ffd24a",
  ...
  pesDeCinza: {
    id: "pesDeCinza", cls: "warlock", name: "Pés de Cinza", color: "#9fe6ff",
