...
Object.assign(PASSIVES, {
  ...
  chamaVerde: {
    id: "chamaVerde", name: "Chama Verde", color: "#7fdc4a",
    desc: "Todo DoT tica 20% mais rápido — vale para qualquer peça que aplique DoT.",
    global: { dotHaste: 1.2 },
  },

  coroaDeOssos: {
    id: "coroaDeOssos", name: "Coroa de Ossos", color: "#e8e0c8",
  ...
  furiaContida: {
    id: "furiaContida", name: "Fúria Contida", color: "#ffd24a",
  ...
  pesDeCinza: {
    id: "pesDeCinza", name: "Pés de Cinza", color: "#9fe6ff",
