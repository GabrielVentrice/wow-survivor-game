...
Object.assign(PIECES, {
  ...
  wildImps: {
    ...
    stats: { count: 3, respawn: 2.2, damage: 16, duration: 9, range: 280, attackInterval: 0.75, speed: 480 },
  ...
  dreadstalkers: {
    ...
    stats: { count: 2, respawn: 5, damage: 52, duration: 14, range: 460, attackInterval: 0.85 },
    trigger: { type: "autonomous", count: "@count", interval: "@respawn" },
    effects: [
  ...
  felguard: {
    ...
    stats: { count: 1, respawn: 6, damage: 88, duration: 20, range: 210, attackInterval: 0.8, cleave: 80 },
    trigger: { type: "autonomous", count: "@count", interval: "@respawn" },
    effects: [
  ...
  voidwalker: {
    ...
    stats: { count: 2, damage: 28, orbitRadius: 88, orbitSpeed: 1.25, attackInterval: 0.35, pullForce: 26, pullRadius: 150 },
  ...
  doom: {
    ...
    stats: { cooldown: 4, range: 420, targets: 1, dps: 18, duration: 8, tickInterval: 1,
             impDamage: 40, impDuration: 10, impCount: 1, radius: 0 },
  ...
  implosion: {
    ...
    requires: { tag: "summon" },
    stats: { blast: 120, radius: 170, cooldown: 1.4, shield: 20 },
  ...
  netherPortal: {
    ...
    stats: { interval: 9, duration: 14, damage: 44, spawnEvery: 2.4, portalRange: 360 },
  ...
  demonicTyrant: {
    ...
    stats: { count: 1, respawn: 8, damage: 140, duration: 22, range: 360, attackInterval: 0.55, cleave: 120 },
    trigger: { type: "autonomous", count: "@count", interval: "@respawn" },
    effects: [
  ...
  grimoireOfSacrifice: {
    ...
    stats: { interval: 3.5, damage: 170, radius: 200, shield: 55, cap: 420 },
    trigger: { type: "aura", interval: "@interval" },
    effects: [
