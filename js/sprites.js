...
const SPRITE_DATA = {
  ...
  // 2ª forma: um capstone fechado. Precisa dizer, a 19 pixels, que a pele
  // sumiu e que os chifres estao NASCENDO — chifre aberto e da forma 3.
  warlockFel: {
    pal: { o: PAL.inkDeep, d: PAL.vio1, m: PAL.vio2, l: PAL.vio3, f: PAL.vio0, B: PAL.bone2, b: PAL.bone0, e: PAL.fel1, E: PAL.fel2 },
    rows: [
      "..Bb.....Bb..",
      "..Bb.....Bb..",
      "...Bb...Bb...",
