...
const SPRITE_DATA = {
  warlock: {
    pal: { o: PAL.inkDeep, d: PAL.vio1, m: PAL.vio2, l: PAL.vio3, B: PAL.meat1, e: PAL.fel1, f: PAL.vio0, R: PAL.arc1 },
    rows: [
      "......oooo......",
      "....oolllloo....",
      "...ollddddllo...",
  ...
  dreadlord: {
    ...
    rows: [
      ...
      "WW....olllllllo.....WW",
      "WWW..olmdmmmdmlo...WWW",
      "WWWW.oldelmdeldo..WWWW",
      "WWWWWolmlmmmlmdoWWWWWW",
      "WWWWWolmmmmmmmdoWWWWWW",
      "WWWWWolmmmmmmmdoWWWWWW",
      ".WWWWolmmmmmmmdoWWWW..",
      "..WWWolmmmmmmmdoWWW...",
      "...WWolmmdddmmdoWW....",
