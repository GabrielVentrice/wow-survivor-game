...
function animFrame(spr, anim) {
  // Cast wins over the walk cycle: the pose the player reads while a spell
  // goes off is the one that has to be on screen, and a step drawn under a
  // raised arm would just be two poses fighting for the same frame.
  if (anim && anim.cast && spr.cast) return spr.cast;
...
function walkAnim(t, moving) {
  ...
  if (!moving) return { bob: (Math.sin(t * 2) - 1) * 0.9, frame: 0, cast: false, sclX: 1, sclY: 1, rot: 0 };
  const ph = t * 9;
...
function drawSprite(ctx, spr, cx, cy, drawH, flip, flashAlpha, anim) {
  ...
  const p = placeSprite(cx, cy, fr.canvas.width, fr.canvas.height, drawH, anim);
  ctx.save();
...
const NO_ANIM = { bob: 0, frame: 0, cast: false, sclX: 1, sclY: 1, rot: 0 };
...
const SPRITE_DATA = {
  ...
  // Iniciado. Chifres rompem a testa, um antebraco ja e osso e o rosto encovou.
  warlockAdept: {
    pal: { o: PAL.inkDeep, d: PAL.vio1, m: PAL.vio2, l: PAL.vio3, b: PAL.bone0, B: PAL.bone1, L: PAL.bone2, e: PAL.fel1 },
    rows: [
      "....ooooo....",
      ".BBollmmddBB.",
      ".bBollmmddBb.",
  ...
  // Colheita. O manto apodreceu em raizes e a caixa toracica esta escancarada.
  warlockColheita: {
    pal: { o: PAL.inkWarm, d: PAL.rot1, m: PAL.rot2, l: PAL.rot3, b: PAL.bone0, B: PAL.bone1, L: PAL.bone2, e: PAL.fel2 },
    rows: [
      "bB...ollllo...Bb",
      ".bB.olmmmmdo.Bb.",
      "..bBolmmmmdoBb..",
  ...
  // Tirania. Coroa de ferro, ombreiras douradas, e os pes nao tocam mais o chao.
  warlockTirania: {
    pal: { o: PAL.inkDeep, d: PAL.vio1, m: PAL.vio2, l: PAL.vio3, s: PAL.gold0, S: PAL.gold1, G: PAL.gold2, b: PAL.bone0, B: PAL.bone1, e: PAL.arc2 },
    rows: [
      "....S.S.S.S.....",
      "....SsSsSsSs....",
      "....oSSSSSSo....",
  ...
  // Nihilam. Queimado ate a casca: o cranio a mostra e o tronco rachado de brasa.
  warlockNihilam: {
    pal: { o: PAL.inkWarm, d: PAL.emb0, m: PAL.emb1, l: PAL.emb2, D: PAL.stone0, M: PAL.stone1, L: PAL.stone2, e: PAL.pyr2 },
    rows: [
      "LM...ollllo...ML",
      ".LM.olmmmmdo.ML.",
      "..LMolmmmmdoML..",
  ...
  // Ceifador. Caveira dentro do capuz, garras longas, cranios de imp na barra.
  warlockCeifador: {
    pal: { o: PAL.inkDeep, d: PAL.vio1, m: PAL.vio2, l: PAL.vio3, b: PAL.bone0, B: PAL.bone1, L: PAL.bone2, e: PAL.fel1 },
    rows: [
      ".....ollllo.....",
  ...
  // Chamador. Coroa de ferro negro e um sino rachado pendurado no peito.
  warlockChamador: {
    pal: { o: PAL.inkWarm, d: PAL.emb0, m: PAL.emb1, l: PAL.emb2, s: PAL.steel0, S: PAL.steel1, L: PAL.steel2, e: PAL.pyr1 },
    rows: [
      "....S.S.S.S.....",
      "....SsSsSsSs....",
      "....oSSSSSSo....",
  ...
  // Diabolista. Selo de latao as costas, mascara com chifres, e nenhum passo.
  warlockDiabolista: {
    pal: { o: PAL.inkCold, d: PAL.void1, m: PAL.void2, l: PAL.void3, s: PAL.gold0, S: PAL.gold1, G: PAL.gold2, e: PAL.arc1 },
    rows: [
      ".....sSSSso.....",
      "....sSGGGSso....",
      "....sSGmmGSs....",
  ...
  // Voraz. O tronco abriu numa boca de presas que vai do peito a cintura.
  warlockVoraz: {
    pal: { o: PAL.inkWarm, d: PAL.meat0, m: PAL.meat1, l: PAL.meat2, b: PAL.bone0, B: PAL.bone1, M: PAL.meat2, e: PAL.fel1 },
    rows: [
      "bB...ollllo...Bb",
      ".bB.olmmmmdo.Bb.",
      "..bBolmmmmdoBb..",
  ...
  // Enxame. O peito e os ombros racharam em celulas de colmeia sob placas de quitina.
  warlockEnxame: {
    pal: { o: PAL.inkDeep, d: PAL.vio1, m: PAL.vio2, l: PAL.vio3, b: PAL.bone0, B: PAL.bone1, L: PAL.bone2, e: PAL.arc1 },
    rows: [
      ".....ollllo.....",
      "....olmmmmdo....",
      "....olmmmmdo....",
  ...
  // Esqueleto: a 16 linhas o que separa ele do resto e o CHIFRE e o vao da
  // caixa toracica. Orbita e osso sao buraco (o), nunca cor por cima do osso.
  skeleton: {
    pal: { o: PAL.inkDeep, d: PAL.bone0, m: PAL.bone1, l: PAL.bone2, D: PAL.steel0, M: PAL.steel1, L: PAL.steel2, e: PAL.fel1 },
    rows: [
      "oo..........oo",
      "lmo........omd",
      ".olmo....omdo.",
  ...
  // Abominacao: massa. A leitura e o corpo inchado com o ventre RASGADO e a
  // costura de grampos — sem elas vira ogro. Bracos pendem por fora do tronco.
  abomination: {
    pal: { o: PAL.inkWarm, d: PAL.meat0, m: PAL.meat1, l: PAL.meat2, D: PAL.bone0, M: PAL.bone1, L: PAL.bone2, e: PAL.gold2 },
    rows: [
      ".........LM......MD.........",
      ".........LM......MD.........",
      ".........oloooooodo.........",
      ...
      ".........olmmmmmmdo.........",
      ".....oDoDommmmmmmmoDoDo.....",
      "...oommmmDmmmmmmmmmmmmmoo...",
      "..ooDoDmmommmmmmmmmmmDoDoo..",
      "..olmmmmmDmmmmmmmmmmmmmmdo..",
      "..olmmmmmommmmmmmmmmmmmmdo..",
      "..olmmmmmDmmoooooommmmmmdo..",
      "..olmmmddommmDDDDDmddmmmdo..",
      "..olmmmooDmmmooooomoommmdo..",
      "..ommdo..olmmMMMMMo..olmdo..",
      "...omdo..Dlmmoooooo..oldo...",
      "....omo..olmooooooo..omo....",
      ".....oo..olmmoommdo..oo.....",
      "......ooommdo..olmmooo......",
      "......olmmmdo..olmmmdo......",
  ...
  // Dreadlord: e o chefe, entao a silhueta tem que ser a maior e a mais larga
  // da tela. Asa aberta com borda recortada (tres pontas), coroa de chifres, e
  // a perna na sombra da capa — a fatia clara e privilegio do tronco.
  dreadlord: {
    pal: { o: PAL.inkDeep, d: PAL.vio1, m: PAL.vio2, l: PAL.vio3, D: PAL.vio0, M: PAL.vio1, L: PAL.vio2, b: PAL.bone1, B: PAL.bone2, e: PAL.blood1 },
    rows: [
      ".............ooooo..............ooooo.............",
      "...oB........oBBBo..............oBBBo........Bo...",
      "..Boo.........oBBBo.oooo..oooo.oBBBo.........ooB..",
      "..oLDo.........oBBBooBBo..oBBooBBBo.........oLDo..",
      "..oLMDo.........oBBBoBBo..oBBoBBBo.........oLMDo..",
      ".oLMMMMoo........oBBBoBBooBBoBBBo........ooMMMMDo.",
      ".oLMMMMMMoo.......oBBBommmmoBBBo.......ooMMMMMMDo.",
      ".oLMMMMMMMMoo.......olmmmmmmdo.......ooMMMMMMMMDo.",
      "oLMMMMMMMMMMMoo.....dddddddddd.....ooMMMMMMMMMMMDo",
      "oLMMMMMMMMMMMMMoo...oeommmmoeo...ooMMMMMMMMMMMMMDo",
      "oLMMMMMMMMMMMMMMDo..olmmmmmmdo..oLMMMMMMMMMMMMMMDo",
      "oLMMMMMMMMMMMMMMMDo..olmmmmdo..oLMMMMMMMMMMMMMMMDo",
      "oLMMMMMMMMMMMMMMMDo..BlmmmmdB..oLMMMMMMMMMMMMMMMDo",
      "oLMMMMMMMMMMMDDDDDo...olmmdo...oDDDDDMMMMMMMMMMMDo",
      "oLMMMMMMMMMMDoooooo...olmmdo...ooooooDMMMMMMMMMMDo",
      "oLMMDMMMMMMDoooooooooommmmmmooooooooooMMMMMMMDMMDo",
      "oLMMoMMMMMDoolmmdoolmmmmmmmmmmdoolmmdooDMMMMMoMMDo",
      "oLDo.oLMDDo.olmdlommmmmmmmmmmmmdoolmdo.oDDMDo.oLDo",
      "oLDo.oDDMDo.olmdooolmmmmmmmmmmdooolmdo.oLMDDo.oLDo",
      ".oLo..oLDo..olmdooolmmmmmmmmmmdooolmdo..oLDo..oLo.",
      ".oo...oLDo..olmdooooddddddddodoooolmdo..oLDo...oo.",
      ".oo....oLo..olmdoooolmmmmmmmmdoooolmdo..oLo....oo.",
      ".o.....oo....olmdoodmmmmmmmmmmdoolmdo....oo.....o.",
      "........o....olmdooolmmmmmmmmdooolmdo....o........",
      ".............olmdooodmmmmmmmmdooolmdo.............",
      "..............omddoomdddddddddoomddo..............",
      "..............omddooddddddddddoomddo..............",
      "..............odddoooooooooooooodddo..............",
      ".............ooooooooooo..ooooooooooo.............",
      ".............oDoooodddDo..odddDooooDo.............",
      "............oDDDDoodddDo..odddDooDDDDo............",
      "............oDDDDoodddDo..odddDooDDDDo............",
      "...........oDDDDDoodddDo..odddDooDDDDDo...........",
      "...........oDDDDDoodddDo..odddDooDDDDDo...........",
      "............ooooooodddDo..odddDooooooo............",
      ".................oddddDo..oddddDo.................",
      ".................oddddDo..oddddDo.................",
      ".................ooooooo..ooooooo.................",
    ],
...
function buildSprites() {
  for (const id in SPRITE_DATA) {
    ...
    // A cast pose cannot be derived. `walkFrames` gets a step out of one grid
    // because a step is the legs moving inside the grid that already exists;
    // no amount of shifting rows produces an arm that went somewhere else. So
    // it is a second grid or there is no cast pose at all.
    if (d.cast) base.cast = makeSprite(d.cast, d.pal);
    SPRITES[id] = base;
  }
}
